        ...
        <div align="center">
            ...
            <div class="alert alert-success"><strong>HORARIO</strong><br>
                <?php
                     ...
                     $dia = $fecha->format('N');
                    $q_horario= $bdcon->prepare("SELECT  dia, hr_entrada, hr_salida FROM grupos_horario  where cod_subgru='$sub_grupo' AND dia='$dia'");
                    $q_horario->execute();
                    if($q_horario->rowCount()>0){
                      while ($rhora = $q_horario->fetch(PDO::FETCH_ASSOC)) { 
                        ...
                        echo "No existe horario para hoy.";
                    }
                ?>                
            </div>
            ...
            ?>                
                <div class="course-card course-card-list">
                    ...
                    <div class="course-card-body" >
                        <a href="#" onclick="ver_clasesvirtuales(<?=$id_grupo;?>, <?=$_idgrupoRaiz?>, <?=$codest;?>, <?=$sub_grupo?>)">
                            <h4>Recursos didacticos Aula invertida</h4>
                        </a>
                        <p>Todos los recursos didacticos para las aulas invertidas.</p>
                        <div class="course-details-info">
                            <ul>
                                <li> Registrada por <a href="#"> Docente de la materia </a> </li>
                                <li>
                ...
                <div class="course-card course-card-list">
                    ...
                    <div class="course-card-body">
                     <a href="#" onclick="ver_plamat(<?=$codest;?>, <?=$id_grupo;?>, <?=$_idgrupoRaiz?>, <?=$sub_grupo;?>)">
                            ...
                            <h4> Planificacion academica Aula invertida</h4>
                        </a>
                ...
                <div class="course-card course-card-list">
                    <div class="course-card-thumbnail">
                        ...
                        <a href="#" onclick="abrir_cerrar_invertida('<?=$codmat ;?>','<?= $codest; ?>','<?= $per; ?>','<?= $id_grupo; ?>','<?=$sub_grupo;?>')" class="play-button-trigger"></a>
                    </div>
                    <div class="course-card-body">
                        <a href="#" onclick="abrir_cerrar_invertida('<?=$codmat ;?>','<?= $codest; ?>','<?= $per; ?>','<?= $id_grupo; ?>','<?=$sub_grupo;?>')">
                            <h4> Boletin de Notas aula invertida</h4>
                        </a>
                        <p>Ver las notas obtenidas en detalle para el aula invertida.</p>
                        <div class="course-details-info">
                            <ul>
                                <li> Registrada por <a href="#"> Docente de la materia </a> </li>
                                <li>
