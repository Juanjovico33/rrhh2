...
for ($i=1; $i <=15 ; $i++) { 
	...
	$ins_resp=$bdcon->prepare("INSERT INTO plat_est_encu_respuestas VALUES ('0','$cod_encu','$codest','$codpreg','$resp','$fecha','$hora','$codgru','1','$codsubgru','$res_si','$res_no')");
	$ins_resp->execute();
}
?>
